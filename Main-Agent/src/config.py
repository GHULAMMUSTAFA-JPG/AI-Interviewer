...
GEMINI_MODEL_CONVERSATION = os.getenv("GEMINI_MODEL_CONVERSATION", "gemini-2.0-flash-lite")
GEMINI_MODEL_EVALUATION = os.getenv("GEMINI_MODEL_EVALUATION", "gemini-2.0-flash-lite")
